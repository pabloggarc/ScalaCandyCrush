...
class PanelEstrellas extends FlowPanel {

  opaque = false

  private val estrellaVacia: String = "src/img/VidaLlena.png"
  private val estrellaLlena: String = "src/img/VidaVacia.png"
  private val estrellaAzul: String = "src/img/Bomba.png"
